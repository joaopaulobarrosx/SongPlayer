...
public protocol MediaCacheServiceProtocol: Sendable {
...
public final class MediaCacheService: MediaCacheServiceProtocol, Sendable {
    ...
    public func localURL(for remoteURL: URL, kind: Kind) -> URL? {
        let url = fileURL(for: remoteURL, kind: kind)
        return FileManager.default.fileExists(atPath: url.path) ? url : nil
    }

    @discardableResult
    public func download(_ remoteURL: URL, kind: Kind) async throws -> URL {
    ...
    public func prefetch(song: Song) {
